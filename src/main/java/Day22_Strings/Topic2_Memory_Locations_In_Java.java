...
public class Topic2_Memory_Locations_In_Java {
	...
	// Strings memory allocation moved from Method Area to Heap Memory in Java
	// version 1.7
	// String objects will be stored in a niche memory location within Heap Memory -
	// SCP or SLP
	// SCP(String Constant Pool / String Literal Pool)

	public static void main(String[] args) {

		String S1 = new String(); // whenever we create an object using new keyword, the object gets created in
									// Heap Memory
