...
//1-D []
	...
	public static void main(String[] args) {
		...
		// Please retrieve a specific element. For example retrieve element present in
		// position no 9 in d array

		System.out.println("the 9th element in array d is : " + d[8]);

		// Please retrieve a specific element. For example retrieve element present in
		// position no 16 in d array
		// System.out.println("the 9th element in array d is : " + d[15]);
