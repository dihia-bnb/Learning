...
public class DropDown {
	...
	public void makeMyTripAutoSuggestiveDropdown() throws Exception {
		...
		// Let's say we want to select New York - JFKennedy airport and it is getting
		// highlighted at the 5th Down array key
		...
		// Let's say we want to select Las Pierdas - Venezuela airport and it is getting
		// highlighted at the 5th Down array key
		int j = 0;
		while (j < 5) {
			Thread.sleep(1000);
